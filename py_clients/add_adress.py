...
if login_response.status_code == 200:
    ...
    endpoints = "http://127.0.0.1:8000/api/add-address/"
    data = {"label": "Uncle address", "street_address":"Chicago", "city":"Hollywood", "state":"California", "postal_code":"20510","country": "America"}
    headers = {
